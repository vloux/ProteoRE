...
mapping = function() {
  # Define files path
  np_ensg_file = "/projet/galaxydev/galaxy/tools/proteore_uc1/mapping/nextprot_ensg.txt"
  np_ensp_file = "/projet/galaxydev/galaxy/tools/proteore_uc1/mapping/nextprot_ensp.txt"
  np_enst_file = "/projet/galaxydev/galaxy/tools/proteore_uc1/mapping/nextprot_enst.txt"
  np_geneID_file = "/projet/galaxydev/galaxy/tools/proteore_uc1/mapping/nextprot_geneid.txt"
  np_hgnc_file = "/projet/galaxydev/galaxy/tools/proteore_uc1/mapping/nextprot_hgnc.txt"
  np_ipi_file = "/projet/galaxydev/galaxy/tools/proteore_uc1/mapping/nextprot_ipi.txt"
  np_mgi_file = "/projet/galaxydev/galaxy/tools/proteore_uc1/mapping/nextprot_mgi.txt"
  np_rs_file = "/projet/galaxydev/galaxy/tools/proteore_uc1/mapping/nextprot_refseq.txt"
